...
package com.silentlabs.android.mobilequeue.view;
...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        ...
        String removeMode = settings.getString("removeTPref", "None");
        if (removeMode.equals("None"))
            mRemoveMode = NONE;
        else if (removeMode.equals("Slide"))
            mRemoveMode = SLIDE;
        else if (removeMode.equals("Fling"))
            mRemoveMode = FLING;
