...
public class DisplayMovieDetailsActivity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ImageButton addImageButton = (ImageButton)
        // findViewById(R.id.addImageButton);
        // if (type.equals("BROWSE") || type.equals("HISTORY") ||
        // type.equals("SIMILAR")) {
    ...
    protected void setupTabHost() {
        ...
        // ((TextView)
        // findViewById(R.id.title_text)).setText(movieTitle.getTitleReqular());
        ...
        try {
            ...
            boxArt.setImageResource(R.drawable.ic_launcher);
        }
